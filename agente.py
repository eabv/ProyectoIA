...
######################################################################################################################
            ...
            if casa.ubicacionestado['C2'] == 1:
                ...
                if casa.ubicacionestado['C6'] == 1:
                         ...
                         casa.ubicacionestado['C6'] == 0
                         costo = costo + 1
                         print("Se activa el aire acondicionado en la casa 6, el agente pasa a la cas 7")
                         print("costo:", costo, "\n")  
                else:
                     print("El agente no detecta movimiento en la casa 6, el agente pasa a la casa 7\n")
                ...
                if casa.ubicacionestado['C7'] == 1:
                         ...
                         casa.ubicacionestado['C7'] == 0
                         costo = costo + 1
                         print("Se activa el aire acondicionado en la casa 7, el agente pasa a la cas 1")
                         print("costo:", costo, "\n")  
                else:
